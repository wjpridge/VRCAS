...
public class BESS_TEST1 extends Activity implements SensorEventListener {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            fOut.write("Single Leg Test Start");
        } catch (IOException e) {
            e.printStackTrace();
        }
...
//        Set up the user interaction to manually show or hide the system UI.
    ...
    public void onFinish(){
        try {
            fOut.write("BESS_TEST1 Finished");
            fOut.flush();
            BESS_TEST1.this.startActivity(new Intent(BESS_TEST1.this, BESS_TEST2.class));
        } catch (IOException e) {
            e.printStackTrace();
        }
        sensorManager.unregisterListener(this);
