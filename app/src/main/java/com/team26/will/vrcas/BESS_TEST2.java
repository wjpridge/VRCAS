...
public class BESS_TEST2 extends Activity implements SensorEventListener {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            fOut.write("Double Leg Test Start");
        } catch (IOException e) {
            e.printStackTrace();
        }
...
//        Set up the user interaction to manually show or hide the system UI.
    ...
    public void onFinish(){
        try {
            fOut.write("BESS_TEST2 Finished");
            fOut.flush();
            BESS_TEST2.this.startActivity(new Intent(BESS_TEST2.this, BESS_TEST3.class));
        } catch (IOException e) {
            e.printStackTrace();
        }
        sensorManager.unregisterListener(this);
